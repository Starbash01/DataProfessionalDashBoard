# DataProfessionalDashBoard
Power BI Data Professional Dashboard analyzing survey responses from data professionals. The dashboard explores salary trends, job roles, programming language preferences, work-life balance, job satisfaction, and career demographics through interactive visualizations, providing insights into industry trends and workforce experiences.

## Powerbi Interface
- <a href="https://github.com/Starbash01/DataProfessionalDashBoard/blob/main/Data%20Professional%20Dashboard.pbix"> Feel free to download, explore and interact with this project. You're welcome to use it as a reference, adapt it to your own dataset, and experiment with different analyses or visualizations. I hope it provides useful insights and serves as a helpful resource for your own learning and projects.
